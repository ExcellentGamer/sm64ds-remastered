const struct Animation *const bowser_animations[] = {
    &bowser_seg6_anim_060445EC, // stand up
    ...
    &bowser_seg6_anim_06049880, // fire start
    ...
    &bowser_seg6_anim_0604FF4C, // walk
    &bowser_seg6_anim_06050530, // walk end
    &bowser_seg6_anim_060514E8, // walk start

...
static const LevelScript script_func_local_1[] = {
		...
		OBJECT_WITH_ACTS(MODEL_BULLET_BILL, 1280, 3584, 922, 0, 180, 0, 0, bhvBulletBill, ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
...
const LevelScript level_wf_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_LEVEL_GEOMETRY_09,                bullet_bill_cannon_geo),

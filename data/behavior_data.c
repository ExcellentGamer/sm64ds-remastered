...
const BehaviorScript bhvPiranhaPlant[] = {
    ...
    LOAD_ANIMATIONS(oAnimations, piranha_plant_animations),
    ANIMATE(8),
    SET_INTERACT_TYPE(INTERACT_DAMAGE),
    SET_HITBOX(300, 150),
    SET_HURTBOX(250, 150),
    ...
    SET_INT(oDamageOrCoinValue, 3),
    SET_INT(oNumLootCoins, 5),
    SPAWN_CHILD(MODEL_BUBBLE, bhvPiranhaPlantBubble),
...
const BehaviorScript bhvSmallWhomp[] = {
    ...
    // Whomp - common:
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, whomp_animations),
...
const BehaviorScript bhvBobomb[] = {
    ...
    LOAD_ANIMATIONS(oAnimations, bobomb_animations),
    DROP_TO_FLOOR(),
    ANIMATE(0),
    SET_INT(oIntangibleTimer, 0),
    SET_HOME(),
...
const BehaviorScript bhvBobombBuddy[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_HOLDABLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, bobomb_buddy_animations),
    SET_INTERACT_TYPE(INTERACT_TEXT),
    DROP_TO_FLOOR(),

...
s16 set_player_animation(struct PlayerState *m, s32 targetAnimID) {
    ...
    if (curChar == 0 && (targetAnimID != YOSHI_ANIM_RUN) && (targetAnimID != YOSHI_ANIM_JUMP) && (targetAnimID != YOSHI_ANIM_JUMP_LAND) && (targetAnimID != YOSHI_ANIM_IDLE) && (targetAnimID != YOSHI_ANIM_EAT) && (targetAnimID != YOSHI_ANIM_EAT_FAIL)) {
